...
# https://github.com/bro-n-bro/osmopy
# https://github.com/hukkin/cosmospy
# https://www.mintscan.io/osmosis
# https://docs.osmosis.zone/developing/modules/spec-lockup.html#account-locked-longer-duration-denom
# https://github.com/osmosis-labs/osmosis/blob/main/cmd/osmosisd/cmd/testnetify/testnetify.py
# https://github.com/UnityChaos/OsmosisData
...
class Osmosis:
    def __init__(self, network='MAINNET', walletAddress='', walletMnemonic=''):
        if network == 'MAINNET':
            chain_id = 'columbus-5'
            public_node_url = 'https://lcd-osmosis.keplr.app'
...
#            rev_Contract_addresses = contract_addresses.rev_contact_addresses(contact_addresses)
            ...
            chain_id = 'bombay-12'
            public_node_url = 'https://api.studio.thegraph.com'
            # tx_look_up = f'https://finder.terra.money/{chain_id}/tx/'
